            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <a class="" href="{{url('website/create')}}">
                ...
                <div class="ibox-content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-example" id="websiteTable">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Site Name</th>
...
@push("scripts")
 ...
 @if(Session::has('website_create'))
	<script>
		toastrDisplay("success","{{ Session::get('website_create') }}");
	</script>
 @endif
...
<script>
    ...
    columns: [
        ...
        { data: 'sitelogo', name: 'slider_img', render:function(o){
            //console.log(o);
            return '<img src="http://localhost/blog/public/storage/Website/' + o + '" width="150px" height="150px" />';
        }},
        ...
        {data: null,  orderable: false, searchable: false,render:function(o){
        return '<a href="javascript:void(0);" data-toggle="modal" data-id="' + o.id + '" data-target="#mymodel" id="mymodel1"> <img src="{{ url("storage/images/view-icon.png")}}"> </a> <a href="website/'+o.id+'/edit"> <img src="{{ url("storage/images/edit-icon.png")}}"> </a> <a href="javascript:void(0)" data-id="'+o.id+'" class="websiteSettings"> <img src="{{ url("storage/images/delete-icon.png")}}"> </i> </a>';
}}
    ]});
});
...
$(document).on('click','.websiteSettings',function(){
		var id=$(this).data("id");
		var delAdmin = confirm("Do you want to delete Website Settings ?");
            if (delAdmin == true) {
                $.ajax({
                    type: "DELETE",
                    url: "{{url('website')}}/"+id,
