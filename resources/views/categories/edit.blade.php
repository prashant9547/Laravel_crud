        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
						<div class="row">
								<div class="col-md-6">
                {{  Form::model( $accountDetail, ['method' => 'PUT', 'enctype' => 'multipart/form-data', 'route' => ['categories.update', $accountDetail->id],"name"=>"editcategories"]) }}
...
<script type="text/javascript">
 $("form[name='editcategories']").validate({
             rules: {
               catName :"required",
               catImg:"required",
