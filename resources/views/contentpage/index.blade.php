            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <a class="" href="{{url('contentpage/create')}}">
                ...
                <div class="ibox-content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-example" id="contentpage">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Page Title</th>
...
@push("scripts")
 ...
 @if(Session::has('contentpage_update'))
	<script>
		toastrDisplay("success","{{ Session::get('contentpage_update') }}");
	</script>
 @endif

 @if(Session::has('contentpage_create'))
	<script>
		toastrDisplay("success","{{ Session::get('contentpage_create') }}");
	</script>
 @endif
...
<script>
    ...
    columns: [
        ...
        { data: 'content_des', name: 'content_des'},
        ...
        {data: null,  orderable: false, searchable: false,render:function(o){
        return '<a href="javascript:void(0);" data-toggle="modal" data-id="' + o.id + '" data-target="#mymodel" id="mymodel1"> <img src="{{ url("storage/images/view-icon.png")}}"> </a> <a href="contentpage/'+o.id+'/edit"> <img src="{{ url("storage/images/edit-icon.png")}}"> </a> <a href="javascript:void(0)" data-id="'+o.id+'" class="contentpage"> <img src="{{ url("storage/images/delete-icon.png")}}"> </i> </a>';
}}
    ]});
});
...
$(document).on('click','.contentpage',function(){
		var id=$(this).data("id");
		var delAdmin = confirm("Do you want to delete Content Page ?");
            if (delAdmin == true) {
                $.ajax({
                    type: "DELETE",
                    url: "{{url('contentpage')}}/"+id,
                    headers: {
